...
class MaterialObject(GunaProtocol):
    def get_guna_profile(self) -> GunaProfile:
        ...
        return GunaProfile(sattva=Decimal("0.2"), rajas=Decimal("0.5"), tamas=Decimal("0.3"), visuddha=ZERO)
...
class ConcreteMantra(MantraProtocol):
    def chant(self, frequency_hz=432.0) -> float:
        return 1.0

    def surrender(self, context) -> None:
        pass

    def get_alignment_score(self) -> float:
        return 1.0

    def receive_mantra(self, mantra) -> None:
        pass
