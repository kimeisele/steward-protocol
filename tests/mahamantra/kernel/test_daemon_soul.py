...
from vibe_core.mahamantra.kernel.daemon import DaemonState, EntropyLevel, MahamantraDaemon
...
@pytest.mark.asyncio
@pytest.mark.skip(reason="Singularity import triggers heavy init despite mock — daemon.start() times out")
