...
class TestSeedSync:
    ...
    def test_guardian_completeness(self) -> None:
        ...
        from vibe_core.mahamantra.protocols._seed import (
            AVATAR_COUNT, MAHAJANA_COUNT, WORDS
        )
    ...
    def test_substrate_avataras_match_count(self) -> None:
        ...
        from vibe_core.mahamantra.substrate.seed import AVATARAS, AVATAR_COUNT
    ...
    def test_substrate_mahajanas_match_count(self) -> None:
        ...
        from vibe_core.mahamantra.substrate.seed import MAHAJANAS, MAHAJANA_COUNT
