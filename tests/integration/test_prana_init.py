...
from vibe_core.plugins.vedic_governance.varna import Varna, categorize_agent_by_function
...
class TestPranaInitializer:
    ...
    def test_constitution_verification(self):
        ...
        # Go up 3 levels: test_prana_init.py -> integration/ -> tests/ -> project root
