...
class TestPranaE2EOpusUpdate:
    ...
    def test_opus_assistant_plugin_on_pulse_e2e(self, tmp_path):
        ...
        try:
            ...
            # Create dummy Jinja2 template so renderer works
            template_dir = tmp_path / "vibe_core/plugins/opus_assistant/templates"
            template_dir.mkdir(parents=True, exist_ok=True)
            (template_dir / "opus_dashboard.md.j2").write_text(
                "# OPUS - System Dashboard\n\n"
