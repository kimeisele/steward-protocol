...
def test_eventbus_implements_protocol():
    ...
    assert isinstance(bus, EventBusProtocol), (
        "MAYAVAD DETECTED: EventBus does not implement EventBusProtocol! The Protocol is a lie."
    )
...
def test_kernel_implements_protocol():
    ...
    assert isinstance(kernel, KernelProtocol), (
        "MAYAVAD DETECTED: RealVibeKernel does not implement KernelProtocol! This blocks the entire Protocol migration."
    )
...
def test_ledger_implements_protocol():
    ...
    assert isinstance(ledger, VibeLedger), (
        "MAYAVAD DETECTED: SQLiteLedger does not implement VibeLedger! Ledger Protocol migration blocked."
    )
...
def test_inmemory_ledger_implements_protocol():
    ...
    assert isinstance(ledger, VibeLedger), "MAYAVAD DETECTED: InMemoryLedger does not implement VibeLedger!"
...
def test_null_eventbus_implements_protocol():
    ...
    assert isinstance(null_bus, EventBusProtocol), (
        "MAYAVAD DETECTED: NullEventBus does not implement EventBusProtocol! The Arjuna Pattern is broken."
    )
