...
steward verify ambassador

# Discover this agent
steward discover

# Delegate task to this agent
steward delegate ambassador "your task description"
```
...
# Check agent status
steward ps | grep ambassador

# View agent in Parampara blockchain
steward lineage | grep AMBASSADOR
```
