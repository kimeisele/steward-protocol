...
# =============================================================================
# HOLYNAME - IMPORTED FROM SSOT (byte.py facade -> mahamantra/substrate/seed.py)
# =============================================================================
# This eliminates the Split Brain where str,Enum != IntEnum
# The SSOT HolyName is IntEnum with HARE=0, KRISHNA=1, RAMA=2
