...
System integrity and monitoring agent
...
steward verify watchman

# Discover this agent
steward discover

# Delegate task to this agent
steward delegate watchman "your task description"
```
...
# Check agent status
steward ps | grep watchman

# View agent in Parampara blockchain
steward lineage | grep WATCHMAN
```
