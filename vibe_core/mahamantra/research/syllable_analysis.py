...
RAMA_GRID = {
    # Vowels (0-15)
    "a": 0, "ā": 1, "i": 2, "ī": 3, "u": 4, "ū": 5,
    "ṛ": 6, "ṝ": 7, "ḷ": 8, "ḹ": 9,
    "e": 10, "ai": 11, "o": 12, "au": 13, "ṁ": 14, "ḥ": 15,
    
    # Ka-varga (Guttural) 16-20
    "ka": 16, "kha": 17, "ga": 18, "gha": 19, "ṅa": 20,
    
    # Ca-varga (Palatal) 21-25
    "ca": 21, "cha": 22, "ja": 23, "jha": 24, "ña": 25,
    
    # Ṭa-varga (Retroflex) 26-30
    "ṭa": 26, "ṭha": 27, "ḍa": 28, "ḍha": 29, "ṇa": 30,
    
    # Ta-varga (Dental) 31-35
    "ta": 31, "tha": 32, "da": 33, "dha": 34, "na": 35,
    
    # Pa-varga (Labial) 36-40
    "pa": 36, "pha": 37, "ba": 38, "bha": 39, "ma": 40,
    
    # Antastha (Semivowels) 41-44
    "ya": 41, "ra": 42, "la": 43, "va": 44,
    
    # Ushman (Sibilants) 45-48
    "śa": 45, "ṣa": 46, "sa": 47, "ha": 48,
}
...
def run_full_analysis():
    ...
    mahajanas = [
        "brahma", "narada", "shambhu", "kumaras",
        "kapila", "manu", "prahlada", "janaka",
        "bhishma", "bali", "shuka", "yamaraja"
    ]
