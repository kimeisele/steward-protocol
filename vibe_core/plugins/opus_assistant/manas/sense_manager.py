...
1. Initialization of all 5 Jnanendriyas (senses)
...
class SenseManager:
    ...
    This class manages all 5 Jnanendriyas (sense organs) for MANAS:
    1. PrakritiSense - System state perception (Guna)
    2. DharmaSense - Ethical alignment checking
    3. SutraSense - Documentation gap detection
    ...
    def boot_all(self) -> List[SenseBootResult]:
        ...
        logger.info(f"🧘 SENSE MANAGER: Booted {successful}/5 senses")
