...
class TestPromptConstruction:
    """Verify the cognitive system prompt builds correctly from BuddhiResult."""

    def _build_prompt(self, post: str) -> str:
        """Run MahaBuddhi + ContentComposer._build_system() → system prompt."""
    ...
    def test_prompt_has_anti_slop_rules(self):
        prompt = self._build_prompt(MOLTBOOK_POSTS[0])
        assert "No AI filler" in prompt, f"Missing anti-slop rules in prompt"
