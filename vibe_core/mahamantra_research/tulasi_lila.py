...
from vibe_core.mahamantra.protocols._seed import HARE_COUNT, KRISHNA_COUNT, MAHA_QUANTUM, PANCHA, TRINITY
...
class OfferingPipeline:
    ...
    def offer(item: BhogaItem, tulasi: Optional[TulasiLeaf], devotion_score: int) -> Prasadam:
        ...
        return Prasadam(
            original_item=item.name, transcendental_value=final_value, mercy_factor=guru_mercy + pancha_mercy
        )
