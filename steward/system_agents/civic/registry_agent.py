...
class RegistryAgent(VibeAgent):
    ...
    def process(self, task: Task) -> Dict[str, Any]:
        """Process registry-related tasks."""
        ...
        elif action == "update_agents_registry":
            return self.update_agents_registry(
                dry_run=task.payload.get("dry_run", False)
            )
    ...
    def update_agents_registry(self, dry_run: bool = False) -> Dict[str, Any]:
        """Update AGENTS.md from registry."""
    ...
    def _generate_agents_markdown(self, agents: Dict[str, Dict]) -> str:
        ...
        lines = [
            "# 🤖 AGENT CITY REGISTRY",
            "",
            "**Auto-generated by CIVIC (Registry Agent)**",
