...
**🟢 HEALTHY** | Updated: 2025-12-21 00:08:20 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/state-file-architecture-PigwR` @ `cf5ff75`
...
**Trust Score: **🟢 HEALTHY** 80%** (89 docs verified, 26 without @HARNESS)
...
**114 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 209 | ✅ | `vibe_core/plugins/` |
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 8 | feat(opus166): MANAS reacts to PranaSens |
...
| `vibe_core/protocols/agent.py` | 3 | refactor(opus166): LASAGNE Architecture  |
| `vibe_core/prana_orchestrator.py` | 3 | test(opus165): E2E tests for KALA time o |
...
| Started | `2025-12-21T00:08:04.608161` |
...
| --- | --- | --- |
| Hidden Code Elements | 388 | ⚠️ 12 high priority |
...
*Last Scan: 2025-12-21 00:08:41 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-21 00:08:20 UTC*