...
Last Updated: 2025-12-20 11:45 UTC
...
**🟢 HEALTHY** | Updated: 2025-12-20 11:45:12 UTC | Kernel: RUNNING (0 agents)
...
|-------|-----------|--------|
| **Last Synapse Update** | `2025-12-20T11:01:02` | 🟢 Active |
| **Last Viveka Decision** | `2025-12-20T11:01:02` | 🔱 Active |
| **Last Reinforcement** | `2025-12-20T11:01:02` | ✅ +0.05 |
| **Synapses File** | `2025-12-20T11:44:02` | 📄 .opus_state/synapses.json |

<details>
<summary>Last Reinforcement Details</summary>

- **Intent:** `resolve_state_conflict`
- **Title:** State file conflict during pull
- **Result:** ✅ Success- **Weight:** 0.550 → 0.600
- **Delta:** 0.050
...
|--------|-------|-------------|
| **Synapses** | 42 triggers / 42 connections | Learned patterns |
| **Avg Weight** | 🟠 **0.44** | Pattern confidence |
| **High Confidence** | 1 | Weights > 0.8 |
| **Low Confidence** | 3 | Weights < 0.3 |
| **Latest Learning** | `2025-12-20T11:01:02` | Most recent synapse |
...
|--------|----------|---------------|-----------|
| `classify_file` | ⚠️ WARN_EXECUTE | 0.50 | `2025-12-20T11:01` |
| `classify_file` | ⚠️ WARN_EXECUTE | 0.50 | `2025-12-20T11:01` |
| `classify_file` | ⚠️ WARN_EXECUTE | 0.50 | `2025-12-20T11:01` |
| `evaluate_auto_commit` | ⚠️ WARN_EXECUTE | 0.50 | `2025-12-20T11:01` |
| `evaluate_commit_strategy` | ⚠️ WARN_EXECUTE | 0.50 | `2025-12-20T11:01` |
...
- **Branch:** `claude/state-file-architecture-PigwR` @ `9c025ce`
...
**Trust Score: **🟢 HEALTHY** 81%** (78 docs verified, 22 without @HARNESS)
...
**99 documents** in `docs/architecture/OPUS/`
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/cortex/viveka_action.py` | 13 | feat(OPUS-133): GURUKULA Integration - A |
| `vibe_core/plugins/opus_assistant/manas/intent_router.py` | 6 | feat(OPUS-133): PRASADAM + Documentation |
| `vibe_core/plugins/opus_assistant/manas/cortex/viveka_sense.py` | 4 | feat(OPUS-133): GURUKULA Integration - A |
| `vibe_core/plugins/opus_assistant/manas/dojo/__init__.py` | 4 | feat(OPUS-133): GURUKULA Phase 1 - GAD-0 |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 3 | feat(OPUS-133): GURUKULA Integration - A |
| `vibe_core/plugins/opus_assistant/manas/dojo/runner.py` | 3 | feat(OPUS-133): PROJECT DOJO v2 - German |
| `vibe_core/plugins/opus_assistant/manas/cortex/__init__.py` | 3 | fix(manas): Export all 5 senses from cor |
...
| `vibe_core/plugins/opus_assistant/render/opus_dashboard_renderer.py` | 2 | feat(OPUS-133): Operational timestamps f |
...
| Started | `2025-12-20T11:44:31.962126` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/state-file-architecture-PigwR` |
...
*Last Scan: 2025-12-20 11:45:27 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-20 11:45:12 UTC*