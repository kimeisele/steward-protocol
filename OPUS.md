...
**🟡 DEGRADED** | Updated: 2025-12-17 16:33:22 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/fix-output-verification-PBjus` @ `1ade88b`
...
**Trust Score: **🟡 DEGRADED** 79%** (50 docs verified, 16 without @HARNESS)
...
**65 documents** in `docs/architecture/OPUS/`
...
|------|---------|-------------|
| `vibe_core/__init__.py` | 1 | Merge pull request #516 from kimeisele/c |
| `vibe_core/agent_interface.py` | 1 | Merge pull request #516 from kimeisele/c |
| `vibe_core/agent_protocol.py` | 1 | Merge pull request #516 from kimeisele/c |
| `vibe_core/agents/__init__.py` | 1 | Merge pull request #516 from kimeisele/c |
| `vibe_core/agents/context_aware_agent.py` | 1 | Merge pull request #516 from kimeisele/c |
| `vibe_core/agents/llm_agent.py` | 1 | Merge pull request #516 from kimeisele/c |
| `vibe_core/agents/specialist_agent.py` | 1 | Merge pull request #516 from kimeisele/c |
| `vibe_core/agents/specialist_factory.py` | 1 | Merge pull request #516 from kimeisele/c |
| `vibe_core/agents/system_maintenance.py` | 1 | Merge pull request #516 from kimeisele/c |
| `vibe_core/boot_mode.py` | 1 | Merge pull request #516 from kimeisele/c |
...
| Started | `2025-12-17T16:33:11.473082` |
...
| Roadmap Items | 39 | 📋 Action needed |
| Intent Clusters | 0 | ⚪ |
...
*Last Scan: 2025-12-17 16:33:30 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-17 16:33:22 UTC*