...
Last Updated: 2025-12-10 13:24:46 UTC
...
**Trust Score: 🟡 70%** (21 docs verified, 1 without @HARNESS)

### OPUS Docs

| Doc | Score | Files | Tests | Wiring | Absent | Config |
|-----|-------|-------|-------|--------|--------|--------|
| 001-KERNEL-EXTRACTION.md | 90% | ✅ | ✅ | ✅ | ✅ | ✅ |
| 002-PHOENIX-CONFIG.md | 90% | ✅ | ✅ | ✅ | ✅ | ✅ |
| 003-AOS-FOUNDATION-REPAIR | 90% | ✅ | ✅ | ✅ | ✅ | ✅ |
| 004-BOOT-SEQUENCE-AUDIT.m | 35% | ❌ | ✅ | ❌ | ✅ | ✅ |
| 005-UNIFICATION-ROADMAP.m | 60% | ❌ | ✅ | ✅ | ✅ | ✅ |
| 006-GAD000-COMPLIANCE-AUD | 35% | ❌ | ❌ | ✅ | ✅ | ✅ |
| 007-UNIFIED-UI-RENDERING. | 65% | ✅ | ❌ | ✅ | ✅ | ✅ |
| 008-INDEX.md | - | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| 009-UNIFIED-STATE-PRAKRIT | 65% | ✅ | ❌ | ✅ | ✅ | ✅ |
| 010-VERIFICATION-PROTOCOL | 65% | ✅ | ✅ | ❌ | ✅ | ✅ |
...
- **001-KERNEL-EXTRACTION.md** [doc]: ## Status
- **001-KERNEL-EXTRACTION.md** [doc]: ## Implementation
- **002-PHOENIX-CONFIG.md** [doc]: ## Status
- **003-AOS-FOUNDATION-REPAIR.md** [doc]: ## Status
- **004-BOOT-SEQUENCE-AUDIT.md** [files]: vibe_core/loaders/plugin_loader.py
- **004-BOOT-SEQUENCE-AUDIT.md** [wiring]: PluginLoader in vibe_core/loaders/plugin_loader.py (file not found)
- **004-BOOT-SEQUENCE-AUDIT.md** [wiring]: discover in vibe_core/loaders/plugin_loader.py (file not found)
- **004-BOOT-SEQUENCE-AUDIT.md** [doc]: ## Status
- **004-BOOT-SEQUENCE-AUDIT.md** [doc]: ## Implementation
- **005-UNIFICATION-ROADMAP.md** [files]: vibe_core/loaders/plugin_loader.py
- _...and 44 more_
<!-- /@LIVE -->
<!-- @LIVE:code_health -->
...
---
*Generated by OpusRenderer | 2025-12-10 13:24:47 UTC*