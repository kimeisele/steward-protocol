...
**🟢 HEALTHY** | Updated: 2025-12-14 23:29:41 UTC | Kernel: STOPPED (0 agents)
...
**Status:** 65.5% real success | 500 total | 324 learned
> 🔒 **Security System Active:** 5 permission denials (correct behavior, not failures!)

| Time | Intent | Type | Result |
|------|--------|------|--------|
| `9.654488` | Test syscall broadcast | **BROADCAST_EVENT** | ✅ |
| `9.649327` | Test syscall broadcast | **BROADCAST_EVENT** | ✅ |
| `9.644651` | Test syscall broadcast | **BROADCAST_EVENT** | ✅ |
| `9.639552` | Test syscall broadcast | **BROADCAST_EVENT** | ✅ |
| `9.634741` | Test syscall broadcast | **BROADCAST_EVENT** | ✅ |

**By Type:**
- `GRANT_MANDATE`: 0/171 successful
- `ALLOCATE_PRANA`: 186/186 successful
- `SPAWN_COGNITION`: 125/125 successful
- `REVOKE_MANDATE`: 5/10 successful (🔒 5 security blocks)
- `BROADCAST_EVENT`: 8/8 successful
...
- **Branch:** `claude/dharma-jnana-integration-xGOfT` @ `b2cac78`
...
- **Trend:** ➡️ Stable- **Last Update:** `2025-12-14T23:29:41.690599` (errors: 0, crashes: 0)
...
**9 circuits** ready for autonomous execution
...
flowchart LR
    ...
    subgraph Circuits["⚡ Circuits"]
        ...
        C6[GENESIS_CHECK]
        C7[KARMA_CONSEQUENCE]
        C8[MANAS_AWAKENING]
        C9[OPUS_VIEW_CONTROL]
    end
...
**Trust Score: **🟢 HEALTHY** 87%** (31 docs verified, 20 without @HARNESS)
...
**50 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 150 | ✅ | `vibe_core/plugins/` |
...
|------|---------|-------------|
| `vibe_core/plugins/vedic_governance/plugin_main.py` | 4 | Revert "feat(opus-071): 💰 Wallet Stub -  |
| `vibe_core/circuit_executor.py` | 2 | feat(opus-072): Wire circuit executor to |
| `vibe_core/cartridges/system/manas/cartridge_main.py` | 2 | feat(opus-072): MANAS identity proxy for |
| `vibe_core/cartridges/system/__init__.py` | 2 | feat(opus-072): MANAS Devata - The 16th  |
| `vibe_core/plugins/opus_assistant/core/state_manager.py` | 2 | feat(opus-072): 🔍 PRATYAKSHA - Metrics s |
| `vibe_core/plugins/vedic_governance/wallet.py` | 2 | Revert "feat(opus-071): 💰 Wallet Stub -  |
| `vibe_core/plugins/opus_assistant/events/kernel_tick.py` | 2 | feat(opus-071): 🌉 Governance Bridge - P1 |
| `vibe_core/plugins/opus_assistant/manas/cortex/sutra.py` | 2 | feat(opus-071): 📜 SUTRA Wiki Sync Live - |
| `vibe_core/plugins/opus_assistant/manas/intent_router.py` | 2 | feat(opus-071): 📜 SUTRA Wiki Sync Live - |
| `vibe_core/cartridges/system/manas/__init__.py` | 1 | feat(opus-072): MANAS Devata - The 16th  |
...
| Started | `2025-12-14T23:29:41.681992` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/dharma-jnana-integration-xGOfT` |
...
---
*Generated by OPUS Assistant Plugin | 2025-12-14 23:29:41 UTC*