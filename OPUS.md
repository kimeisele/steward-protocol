...
**🟢 HEALTHY** | Updated: 2025-12-17 16:01:06 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/fix-agent-wiring-0CXFI` @ `17aac2a`
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 14 | feat(manas): Complete config wiring for  |
| `vibe_core/plugins/opus_assistant/manas/intent_router.py` | 8 | feat(manas): Wire Shiva's Dreaming + San |
| `vibe_core/plugins/opus_assistant/manas/cortex/dharma_sense.py` | 5 | fix(manas): Add _config attribute to Pra |
...
| `vibe_core/plugins/opus_assistant/manas/cortex/prakriti_sense.py` | 2 | fix(manas): Add _config attribute to Pra |
...
| Started | `2025-12-17T16:00:54.155070` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/fix-agent-wiring-0CXFI` |
...
*Last Scan: 2025-12-17 16:01:10 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-17 16:01:06 UTC*