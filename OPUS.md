...
**🟢 HEALTHY** | Updated: 2025-12-20 16:39:33 UTC | Kernel: STOPPED (0 agents)
...
|-------|-----------|--------|
| **Last Synapse Update** | `2025-12-20T15:48:26` | 🟢 Active |
| **Last Viveka Decision** | `2025-12-20T15:48:26` | 🔱 Active |
| **Last Reinforcement** | `2025-12-20T15:48:26` | 🔴 -0.10 |
| **Synapses File** | `2025-12-20T15:48:26` | 📄 .opus_state/synapses.json |
...
|--------|----------|---------------|-----------|
| `evaluate_renderer_pattern` | ⚠️ WARN_EXECUTE | 0.50 | `2025-12-20T15:37` |
| `evaluate_renderer_pattern` | ⚠️ WARN_EXECUTE | 0.50 | `2025-12-20T15:45` |
| `evaluate_renderer_pattern` | ⚠️ WARN_EXECUTE | 0.50 | `2025-12-20T15:45` |
| `evaluate_renderer_pattern` | ⚠️ WARN_EXECUTE | 0.50 | `2025-12-20T15:45` |
| `evaluate_renderer_pattern` | ⚠️ WARN_EXECUTE | 0.50 | `2025-12-20T15:46` |
...
- **Branch:** `claude/state-file-architecture-PigwR` @ `3931736`
...
**Trust Score: **🟢 HEALTHY** 80%** (81 docs verified, 25 without @HARNESS)
...
**105 documents** in `docs/architecture/OPUS/`
...
| `vibe_core/kernel_impl.py` | 3 | feat(harness): Add machine-readable @HAR |
| `vibe_core/plugins/opus_assistant/manas/cortex/viveka_action.py` | 3 | chore(state): Auto-sync runtime state |
| `vibe_core/plugins/interface/renderers/envoy.py` | 2 | feat(interface): OPUS-152 Fractal Interf |
| `vibe_core/plugins/interface/renderers/settings.py` | 2 | feat(interface): OPUS-152 Fractal Interf |
...
| Started | `2025-12-20T16:39:21.118849` |
...
| Roadmap Items | 67 | 📋 Action needed |
| Intent Clusters | 0 | ⚪ |
...
*Last Scan: 2025-12-20 16:39:49 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-20 16:39:33 UTC*