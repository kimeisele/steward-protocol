...
Last Updated: 2025-12-22 11:03 UTC
...
**🟡 DEGRADED** | Updated: 2025-12-22 11:02:58 UTC | Kernel: STOPPED (0 agents)
...
|------|----------|--------|---------|
| `0.428137` | 🚨 | drift_detector | Persistent drift! 8 consecutive unhealthy checks |
| `0.425973` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #8) |
| `9.200855` | 🚨 | drift_detector | Persistent drift! 8 consecutive unhealthy checks |
| `9.198620` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #8) |
| `8.321148` | 🚨 | drift_detector | Persistent drift! 7 consecutive unhealthy checks |
| `8.318118` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #7) |
| `7.663619` | 🚨 | drift_detector | Persistent drift! 9 consecutive unhealthy checks |
| `7.661538` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #9) |
| `6.930684` | 🚨 | drift_detector | Persistent drift! 7 consecutive unhealthy checks |
| `6.929531` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #7) |
| `6.231205` | 🚨 | drift_detector | Persistent drift! 6 consecutive unhealthy checks |
| `6.228753` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #6) |
| `5.380269` | 🚨 | drift_detector | Persistent drift! 8 consecutive unhealthy checks |
| `5.379496` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #8) |
| `3.721857` | 🚨 | drift_detector | Persistent drift! 6 consecutive unhealthy checks |
| ... | ... | ... | _+5 more entries_ |
...
**Trust Score: **🟡 DEGRADED** 79%** (97 docs verified, 33 without @HARNESS)
...
**129 documents** in `docs/architecture/OPUS/`
...
| `vibe_core/kernel_impl.py` | 5 | fix(kernel): OPUS-174 Use safe event emi |
...
| `vibe_core/plugins/opus_assistant/events/kernel_tick.py` | 2 | feat(manas): OPUS-174 Add lightweight ti |
| `vibe_core/plugins/envoy/plugin_main.py` | 2 | fix(envoy): OPUS-174 TÜV audit - remove  |
| `vibe_core/plugins/opus_assistant/manas/akshara.py` | 1 | fix(manas): Remove 61 unused imports, fi |
...
| Started | `2025-12-22T11:02:51.911894` |
...
| Roadmap Items | 92 | 📋 Action needed |
| Intent Clusters | 0 | ⚪ |
...
*Last Scan: 2025-12-22 11:03:14 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-22 11:02:58 UTC*