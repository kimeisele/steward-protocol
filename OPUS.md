...
**🟢 HEALTHY** | Updated: 2025-12-16 14:43:53 UTC | Kernel: STOPPED (0 agents)
...
**Trust Score: **🟢 HEALTHY** 85%** (40 docs verified, 22 without @HARNESS)
...
**61 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 161 | ✅ | `vibe_core/plugins/` |
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/plugin_main.py` | 2 | feat(prana): Wire MANAS to PRANA pulse f |
| `vibe_core/__init__.py` | 1 | fix(lint): Resolve all ruff errors and f |
| `vibe_core/agent_interface.py` | 1 | fix(lint): Resolve all ruff errors and f |
| `vibe_core/agent_protocol.py` | 1 | fix(lint): Resolve all ruff errors and f |
| `vibe_core/agents/__init__.py` | 1 | fix(lint): Resolve all ruff errors and f |
| `vibe_core/agents/context_aware_agent.py` | 1 | fix(lint): Resolve all ruff errors and f |
| `vibe_core/agents/llm_agent.py` | 1 | fix(lint): Resolve all ruff errors and f |
| `vibe_core/agents/specialist_agent.py` | 1 | fix(lint): Resolve all ruff errors and f |
| `vibe_core/agents/specialist_factory.py` | 1 | fix(lint): Resolve all ruff errors and f |
| `vibe_core/agents/system_maintenance.py` | 1 | fix(lint): Resolve all ruff errors and f |
...
| Started | `2025-12-16T01:47:08.471076` |
...
- `vibe_core/prana_orchestrator.py:475` - # TODO: Wire to actual karma system when ready
...
- `vibe_core/plugins/opus_assistant/events/kernel_tick.py:2285` - # TODO: Implement actual logic here
- `vibe_core/plugins/opus_assistant/events/kernel_tick.py:2335` - # TODO: Implement analysis logic
- `vibe_core/plugins/opus_assistant/events/kernel_tick.py:2373` - # TODO: Implement formatting logic
...
---
*Generated by OPUS Assistant Plugin | 2025-12-16 14:43:53 UTC*