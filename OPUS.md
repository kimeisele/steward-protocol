...
**🟡 DEGRADED** | Updated: 2025-12-18 10:21:34 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/enhance-prompt-manas-LhkjA` @ `52362a5`
...
**Trust Score: **🟡 DEGRADED** 79%** (51 docs verified, 17 without @HARNESS)
...
**67 documents** in `docs/architecture/OPUS/`
...
| `vibe_core/agents/context_aware_agent.py` | 1 | Merge pull request #524 from kimeisele/c |
| `vibe_core/agents/llm_agent.py` | 1 | Merge pull request #524 from kimeisele/c |
| `vibe_core/agents/specialist_agent.py` | 1 | Merge pull request #524 from kimeisele/c |
| `vibe_core/agents/specialist_factory.py` | 1 | Merge pull request #524 from kimeisele/c |
| `vibe_core/agents/system_maintenance.py` | 1 | Merge pull request #524 from kimeisele/c |
...
| Started | `2025-12-18T10:21:23.968592` |
...
*Last Scan: 2025-12-18 10:21:41 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-18 10:21:34 UTC*