...
**🟡 DEGRADED** | Updated: 2025-12-18 14:01:37 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/enhance-prompt-manas-LhkjA` @ `529ec67`
...
**Trust Score: **🟡 DEGRADED** 77%** (59 docs verified, 17 without @HARNESS)
...
**75 documents** in `docs/architecture/OPUS/`
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/cortex/silpa_action.py` | 5 | feat(manas): OPUS-105 Genesis Fortress - |
...
| `vibe_core/plugins/opus_assistant/manas/cortex/wiring_map.py` | 3 | feat(manas): OPUS-105 Genesis Fortress - |
...
| `vibe_core/loaders/action_loader.py` | 2 | feat(manas): OPUS-101 Hybrid Router - Ac |
| `vibe_core/plugins/opus_assistant/manas/cortex/shell_action.py` | 2 | feat(manas): OPUS-101 Hybrid Router - Ac |
...
| Started | `2025-12-18T14:01:30.209610` |
...
| --- | --- | --- |
| Hidden Code Elements | 258 | ⚠️ 8 high priority |
...
*Last Scan: 2025-12-18 14:01:46 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-18 14:01:37 UTC*