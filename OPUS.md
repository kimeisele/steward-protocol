...
Last Updated: 2025-12-23 07:54 UTC
...
**🟡 DEGRADED** | Updated: 2025-12-23 07:53:48 UTC | Kernel: RUNNING (0 agents)
...
**Trust Score: **🟡 DEGRADED** 78%** (99 docs verified, 37 without @HARNESS)
...
**135 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 262 | ✅ | `vibe_core/plugins/` |
| **protocols** | VIBE_CORE PROTOCOLS - Layer 1: Interfaces Only | 13 | ❌ | `vibe_core/protocols/` |
...
|------|---------|-------------|
| `vibe_core/plugins/test_orchestration/fixtures.py` | 2 | fix(test): TestKernel.with_governance()  |
| `vibe_core/__init__.py` | 1 | Merge pull request #605 from kimeisele/o |
| `vibe_core/agent_interface.py` | 1 | Merge pull request #605 from kimeisele/o |
| `vibe_core/agent_protocol.py` | 1 | Merge pull request #605 from kimeisele/o |
| `vibe_core/agents/__init__.py` | 1 | Merge pull request #605 from kimeisele/o |
| `vibe_core/agents/context_aware_agent.py` | 1 | Merge pull request #605 from kimeisele/o |
| `vibe_core/agents/llm_agent.py` | 1 | Merge pull request #605 from kimeisele/o |
| `vibe_core/agents/specialist_agent.py` | 1 | Merge pull request #605 from kimeisele/o |
| `vibe_core/agents/specialist_factory.py` | 1 | Merge pull request #605 from kimeisele/o |
| `vibe_core/agents/system_maintenance.py` | 1 | Merge pull request #605 from kimeisele/o |
...
| Started | `2025-12-23T07:53:14.692895` |
...
*Last Scan: 2025-12-23 07:54:10 UTC*
...
- `vibe_core/plugins/test_orchestration/fixtures.py:638` - # TODO: Load only steward_protocol plugin explicitly
...
---
*Generated by OPUS Assistant Plugin | 2025-12-23 07:53:48 UTC*