...
Last Updated: 2025-12-24 17:09 UTC
...
**🟡 DEGRADED** | Updated: 2025-12-24 17:08:55 UTC | Kernel: STOPPED (0 agents)
...
**Trust Score: **🟡 DEGRADED** 75%** (99 docs verified, 41 without @HARNESS)
...
**139 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 264 | ✅ | `vibe_core/plugins/` |
...
|------|---------|-------------|
| `vibe_core/task_management/task_manager.py` | 2 | [chore] OPUS-213 Phase 4: Remove SQLite  |
| `vibe_core/plugins/task_manager/plugin_main.py` | 2 | [feat] OPUS-213 Phase 2-3: Plugin -> Ser |
| `vibe_core/__init__.py` | 1 | feat(opus-213): Phase 0 - atomic_io util |
| `vibe_core/agent_interface.py` | 1 | feat(opus-213): Phase 0 - atomic_io util |
| `vibe_core/agent_protocol.py` | 1 | feat(opus-213): Phase 0 - atomic_io util |
| `vibe_core/agents/__init__.py` | 1 | feat(opus-213): Phase 0 - atomic_io util |
| `vibe_core/agents/context_aware_agent.py` | 1 | feat(opus-213): Phase 0 - atomic_io util |
| `vibe_core/agents/llm_agent.py` | 1 | feat(opus-213): Phase 0 - atomic_io util |
| `vibe_core/agents/specialist_agent.py` | 1 | feat(opus-213): Phase 0 - atomic_io util |
| `vibe_core/agents/specialist_factory.py` | 1 | feat(opus-213): Phase 0 - atomic_io util |
...
| Started | `2025-12-24T17:08:47.926728` |
...
*Last Scan: 2025-12-24 17:09:10 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-24 17:08:55 UTC*