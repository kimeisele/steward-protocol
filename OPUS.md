...
**🟢 HEALTHY** | Updated: 2025-12-17 02:27:48 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/debug-sessionstart-hook-fnWe2` @ `bc9d57b`
...
**Trust Score: **🟢 HEALTHY** 81%** (43 docs verified, 22 without @HARNESS)
...
| **plugins** | Kernel Plugins Package | 171 | ✅ | `vibe_core/plugins/` |
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/intent_router.py` | 6 | feat(live-darshan): MANAS Auto-Generated |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 5 | feat(opus-054): Final Polish - Staleness |
| `vibe_core/plugins/vedic_governance/plugin_main.py` | 5 | feat(prana): Implement Phase 5-6 - Plugi |
| `vibe_core/plugins/opus_assistant/manas/cortex/dharma_sense.py` | 4 | fix(dharma): MANAS grihastha can merge P |
| `vibe_core/plugins/opus_assistant/render/opus_dashboard_renderer.py` | 4 | feat(opus-054): Final Polish - Staleness |
| `vibe_core/plugins/task_manager/plugin_main.py` | 4 | feat(opus-009): TRIPLE STRIKE - Wire Pra |
| `vibe_core/plugins/opus_assistant/manas/cortex/sutra_sense.py` | 3 | feat(opus-054): Final Polish - Staleness |
| `vibe_core/prana_orchestrator.py` | 3 | fix(prana): Enable headless plugin regis |
| `vibe_core/plugins/opus_assistant/manas/cortex/wiring_map.py` | 2 | feat(opus-silpa): Complete Git Circle -  |
| `vibe_core/state/sync_holon.py` | 2 | feat(opus-009): Wire DharmaSense - The V |
...
| Started | `2025-12-17T02:27:35.026488` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/debug-sessionstart-hook-fnWe2` |
...
| Total OPUS Docs | 30 | - |
| With @HARNESS | 13 | ✅ |
| Without @HARNESS | 17 | ⚠️ |
| Doc/Code Gaps | 50 | 🔴 |
| Health Ratio | **43%** | 🔴 |

**Top Gaps (Need Attention):**
- 🟡 `missing_harness`: Doc 050-VEDA.md has no @HARNESS block (050-VEDA.md)
- 🟡 `missing_harness`: Doc 052-AKASHA.md has no @HARNESS block (052-AKASHA.md)
- 🟡 `missing_harness`: Doc 053-SILPA.md has no @HARNESS block (053-SILPA.md)
- 🔴 `missing_code`: Doc 054-SUTRA.md references vibe_core/path/to/file.py but it (054-SUTRA.md)
- 🔴 `missing_code`: Doc 054-SUTRA.md references tests/test_something.py but it d (054-SUTRA.md)
...
| Roadmap Items | 46 | 📋 Action needed |
| Intent Clusters | 0 | ⚪ |
...
- [P2] `add_harness` → 050-VEDA.md (trivial)
- [P2] `add_harness` → 052-AKASHA.md (trivial)


*Last Scan: 2025-12-17 02:27:53 UTC*
...
- `vibe_core/plugins/opus_assistant/events/kernel_tick.py:2312` - # TODO: Implement actual logic here
- `vibe_core/plugins/opus_assistant/events/kernel_tick.py:2362` - # TODO: Implement analysis logic
- `vibe_core/plugins/opus_assistant/events/kernel_tick.py:2400` - # TODO: Implement formatting logic
...
---
*Generated by OPUS Assistant Plugin | 2025-12-17 02:27:48 UTC*
