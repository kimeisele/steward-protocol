...
**🟡 DEGRADED** | Updated: 2025-12-22 20:03:41 UTC | Kernel: STOPPED (0 agents)
...
🧠 **MANAS Active** | 2 pending | Idle: 1 min
...
| **plugins** | Kernel Plugins Package | 256 | ✅ | `vibe_core/plugins/` |
| **protocols** | VIBE_CORE PROTOCOLS - Layer 1: Interfaces Only | 12 | ❌ | `vibe_core/protocols/` |
...
|------|---------|-------------|
| `vibe_core/kernel_impl.py` | 5 | refactor(kernel): OPUS-209 Phase 2.4 - r |
| `vibe_core/state/state_service.py` | 2 | refactor(state): OPUS-209 Phase 1 - remo |
| `vibe_core/state/weaver.py` | 2 | refactor(state): OPUS-209 Phase 1 - remo |
| `vibe_core/protocols/auditor.py` | 1 | refactor(kernel): OPUS-209 Phase 2.4 - r |
| `vibe_core/plugins/resource_limits/__init__.py` | 1 | refactor(kernel): OPUS-209 Phase 2.3 - e |
| `vibe_core/plugins/resource_limits/plugin_main.py` | 1 | refactor(kernel): OPUS-209 Phase 2.3 - e |
| `vibe_core/protocols/resource.py` | 1 | refactor(kernel): OPUS-209 Phase 2.3 - e |
| `vibe_core/plugins/process_isolation/__init__.py` | 1 | refactor(kernel): OPUS-209 Phase 2.2 - e |
| `vibe_core/plugins/process_isolation/plugin_main.py` | 1 | refactor(kernel): OPUS-209 Phase 2.2 - e |
| `vibe_core/protocols/process.py` | 1 | refactor(kernel): OPUS-209 Phase 2.2 - e |
...
flowchart LR
    ...
    subgraph Edges["📦 Import Relations"]
        plugins -->|51| kernel_impl
        cartridges -->|43| tools
        plugins -->|40| state
        cartridges -->|39| steward
        plugins -->|34| loaders
        cartridges -->|31| scheduling
        plugins -->|31| plugin_protocol
...
| Started | `2025-12-22T20:03:36.135026` |
...
*Last Scan: 2025-12-22 20:03:57 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-22 20:03:41 UTC*