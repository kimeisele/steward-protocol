...
**🟢 HEALTHY** | Updated: 2025-12-17 09:49:50 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/review-manas-output-LPQhk` @ `c24c314`
...
**Trust Score: **🟢 HEALTHY** 82%** (43 docs verified, 22 without @HARNESS)
...
|------|---------|-------------|
| `vibe_core/plugins/task_manager/plugin_main.py` | 6 | fix(task-manager): Correct undefined var |
...
| `vibe_core/plugins/opus_assistant/events/kernel_tick.py` | 2 | fix(manas): Add KERNEL_BOOT to fallback  |
...
| Started | `2025-12-17T09:49:36.371765` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/review-manas-output-LPQhk` |
...
*Last Scan: 2025-12-17 09:49:54 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-17 09:49:50 UTC*