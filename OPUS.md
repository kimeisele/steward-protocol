...
Last Updated: 2025-12-20 18:01 UTC
...
**🟡 DEGRADED** | Updated: 2025-12-20 18:00:52 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/state-file-architecture-PigwR` @ `0a5e580`
...
**Trust Score: **🟡 DEGRADED** 79%** (83 docs verified, 25 without @HARNESS)
...
**107 documents** in `docs/architecture/OPUS/`
...
| `vibe_core/plugins/interface/renderers/settings.py` | 3 | feat(interface): OPUS-152 Fractal Interf |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 3 | feat(state): P0 StateService - Single Po |
| `vibe_core/plugins/opus_assistant/manas/dojo/__init__.py` | 3 | feat(dojo): OPUS-140 MeditationRoom - Ja |
...
| Started | `2025-12-20T18:00:38.157428` |
...
| --- | --- | --- |
| Hidden Code Elements | 362 | ⚠️ 10 high priority |
...
*Last Scan: 2025-12-20 18:01:10 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-20 18:00:52 UTC*