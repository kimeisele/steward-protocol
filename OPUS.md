...
**🟡 DEGRADED** | Updated: 2025-12-25 10:06:27 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/optimize-kernel-boot-8CRd2` @ `cf63fef`
...
|------|---------|-------------|
| `vibe_core/boot_orchestrator.py` | 2 | perf(boot): OPUS-306 Optimize kernel boo |
| `vibe_core/plugins/interface/plugin_main.py` | 2 | perf(boot): OPUS-306 Optimize kernel boo |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 2 | perf(boot): OPUS-306 Optimize kernel boo |
| `vibe_core/plugins/opus_assistant/plugin_main.py` | 2 | perf(boot): OPUS-306 Optimize kernel boo |
| `vibe_core/__init__.py` | 1 | chore(state): Sync runtime state files |
| `vibe_core/agent_interface.py` | 1 | chore(state): Sync runtime state files |
| `vibe_core/agent_protocol.py` | 1 | chore(state): Sync runtime state files |
| `vibe_core/agents/__init__.py` | 1 | chore(state): Sync runtime state files |
| `vibe_core/agents/context_aware_agent.py` | 1 | chore(state): Sync runtime state files |
| `vibe_core/agents/llm_agent.py` | 1 | chore(state): Sync runtime state files |
...
| Started | `2025-12-25T10:06:17.310061` |
...
*Last Scan: 2025-12-25 10:06:37 UTC*
...
- `vibe_core/cli/unified_cli.py:71` - "delegate": None,  # TODO: Migrate to plugin
...
---
*Generated by OPUS Assistant Plugin | 2025-12-25 10:06:27 UTC*