...
**🟢 HEALTHY** | Updated: 2025-12-16 20:06:20 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `feature/opus-089-manas-oracle-api` @ `997bce4`
...
| **plugins** | Kernel Plugins Package | 164 | ✅ | `vibe_core/plugins/` |
...
| `vibe_core/agents/specialist_agent.py` | 1 | Merge pull request #489 from kimeisele/c |
| `vibe_core/agents/specialist_factory.py` | 1 | Merge pull request #489 from kimeisele/c |
...
flowchart LR
    ...
    subgraph Edges["📦 Import Relations"]
        ...
        plugins -->|37| kernel_impl
        cartridges -->|31| scheduling
        plugins -->|24| plugin_protocol
...
---
*Generated by OPUS Assistant Plugin | 2025-12-16 20:06:20 UTC*