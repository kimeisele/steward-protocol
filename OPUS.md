...
Last Updated: 2025-12-20 08:23 UTC
...
**🟢 HEALTHY** | Updated: 2025-12-20 08:23:11 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/opus-manas-training-lHO0B` @ `da58b54`
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/cortex/viveka_action.py` | 6 | fix(OPUS-133): Add missing _load_synapse |
| `vibe_core/plugins/opus_assistant/manas/intent_router.py` | 5 | feat(OPUS-133): VivekaAction Real Neural |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 4 | feat(manas): OPUS-133 VivekaAction - The |
| `vibe_core/plugins/opus_assistant/manas/cortex/__init__.py` | 3 | fix(manas): Export all 5 senses from cor |
| `vibe_core/plugins/opus_assistant/manas/cortex/viveka_sense.py` | 3 | fix(manas): Calibrate VivekaSense to det |
| `vibe_core/plugins/task_manager/plugin_main.py` | 3 | feat(OPUS-126): The Karma Loop (Samskara |
...
| `vibe_core/cortex/engines/circuit_engine.py` | 2 | fix(circuits): Correct path to circuits  |
| `vibe_core/plugins/opus_assistant/manas/cortex/karma_sense.py` | 2 | fix(manas): Connect Karma→Viveka synapse |
...
| Started | `2025-12-20T08:22:37.247023` |
...
| --- | --- | --- |
| Hidden Code Elements | 316 | ⚠️ 11 high priority |
...
*Last Scan: 2025-12-20 08:23:24 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-20 08:23:11 UTC*