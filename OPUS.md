...
**🟢 HEALTHY** | Updated: 2025-12-14 17:31:20 UTC | Kernel: STOPPED (0 agents)
...
**Status:** 64.8% success rate | 500 total | 324 learned
...
- `REVOKE_MANDATE`: 5/10 successful
...
- **Branch:** `claude/dharma-jnana-integration-xGOfT` @ `d83ef75`
...
- **Trend:** ➡️ Stable- **Last Update:** `2025-12-14T17:31:19.266059` (errors: 0, crashes: 0)
...
**Trust Score: **🟢 HEALTHY** 87%** (31 docs verified, 4 without @HARNESS)
...
**34 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 147 | ✅ | `vibe_core/plugins/` |
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/cortex/jnana.py` | 7 | feat(opus-055): SANKALPA (The Will) - Pr |
| `vibe_core/plugins/opus_assistant/manas/cortex/veda.py` | 6 | feat(opus-055): SANKALPA (The Will) - Pr |
| `vibe_core/plugins/opus_assistant/events/kernel_tick.py` | 3 | feat(opus-059): PRAMANA (The Valid Proof |
| `vibe_core/plugins/opus_assistant/manas/cortex/__init__.py` | 2 | feat(opus-059): PRAMANA (The Valid Proof |
| `vibe_core/plugins/test_orchestration/playbook_executor.py` | 2 | feat(opus-059): PRAMANA (The Valid Proof |
| `vibe_core/plugins/opus_assistant/manas/cortex/shell.py` | 2 | feat(opus-058): PRATYAHARA (Withdrawal)  |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 2 | feat(opus-057): VAJRA (The Diamond Thund |
| `vibe_core/state/kernel_state.py` | 2 | feat(opus-056): SHUDDHI (The Purificatio |
| `vibe_core/plugins/opus_assistant/manas/cortex/test.py` | 1 | feat(opus-059): PRAMANA (The Valid Proof |
| `vibe_core/plugins/opus_assistant/manas/cortex/sankalpa.py` | 1 | feat(opus-055): SANKALPA (The Will) - Pr |
...
| Started | `2025-12-14T17:31:19.257420` |
...
- `vibe_core/plugins/opus_assistant/events/kernel_tick.py:2288` - # TODO: Implement actual logic here
- `vibe_core/plugins/opus_assistant/events/kernel_tick.py:2338` - # TODO: Implement analysis logic
- `vibe_core/plugins/opus_assistant/events/kernel_tick.py:2376` - # TODO: Implement formatting logic
...
---
*Generated by OPUS Assistant Plugin | 2025-12-14 17:31:20 UTC*