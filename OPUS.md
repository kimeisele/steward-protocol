...
**🟡 DEGRADED** | Updated: 2025-12-19 12:09:53 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/manas-test-suite-j6wB2` @ `a8a3c36`
...
**Trust Score: **🟡 DEGRADED** 78%** (68 docs verified, 12 without @HARNESS)
...
**79 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 177 | ✅ | `vibe_core/plugins/` |
...
|------|---------|-------------|
| `vibe_core/cartridges/system/civic/tools/__init__.py` | 2 | fix(OPUS-098): Consolidate duplicate cla |
| `vibe_core/cartridges/system/civic/tools/economy.py` | 2 | fix(OPUS-098): Consolidate duplicate cla |
| `vibe_core/cartridges/system/civic/tools/ledger_tool.py` | 2 | fix(OPUS-098): Consolidate duplicate cla |
| `vibe_core/cartridges/system/civic/tools/vault.py` | 2 | fix(OPUS-098): Consolidate duplicate cla |
| `vibe_core/state/sync_holon.py` | 2 | fix(OPUS-098): Consolidate duplicate cla |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 2 | fix(OPUS-097): Fix async bug in think()  |
| `vibe_core/state/runtime_state.py` | 2 | refactor(OPUS-096): RuntimeStateDefiniti |
| `vibe_core/cartridges/system/civic/tools/exceptions.py` | 1 | fix(OPUS-098): Consolidate duplicate cla |
| `vibe_core/__init__.py` | 1 | Merge pull request #548 from kimeisele/c |
| `vibe_core/agent_interface.py` | 1 | Merge pull request #548 from kimeisele/c |
...
| Started | `2025-12-19T12:09:44.017103` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/manas-test-suite-j6wB2` |
...
| --- | --- | --- |
| Hidden Code Elements | 276 | ⚠️ 8 high priority |
| Roadmap Items | 58 | 📋 Action needed |
| Intent Clusters | 0 | ⚪ |
...
*Last Scan: 2025-12-19 12:10:06 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-19 12:09:53 UTC*