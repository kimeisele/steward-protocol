...
**🟡 DEGRADED** | Updated: 2025-12-24 18:10:56 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `feature/holistic-autonomy-v1` @ `678fd5a`
...
|------|---------|-------------|
| `vibe_core/kernel_impl.py` | 4 | refactor(opus): resolve all P1 circular  |
| `vibe_core/state/prakriti.py` | 3 | refactor(opus): resolve all P1 circular  |
| `vibe_core/cartridges/system/envoy/provider.py` | 2 | refactor(opus): resolve all P1 circular  |
| `vibe_core/plugins/opus_assistant/events/kernel_tick.py` | 2 | refactor(opus): resolve all P1 circular  |
| `vibe_core/plugins/opus_assistant/plugin_main.py` | 2 | refactor(opus): resolve all P1 circular  |
| `vibe_core/protocols/__init__.py` | 2 | refactor(opus): resolve all P1 circular  |
| `vibe_core/runtime/llm_engine.py` | 2 | refactor(opus): resolve all P1 circular  |
| `vibe_core/state/weaver.py` | 2 | refactor(opus): resolve all P1 circular  |
...
| Started | `2025-12-24T18:10:49.509127` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `feature/holistic-autonomy-v1` |
...
*Last Scan: 2025-12-24 18:11:13 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-24 18:10:56 UTC*