...
**🟢 HEALTHY** | Updated: 2025-12-16 15:55:04 UTC | Kernel: STOPPED (0 agents)
...
|------|---------|-------------|
| `vibe_core/__init__.py` | 1 | fix(prana): Enable headless plugin regis |
| `vibe_core/agent_interface.py` | 1 | fix(prana): Enable headless plugin regis |
| `vibe_core/agent_protocol.py` | 1 | fix(prana): Enable headless plugin regis |
| `vibe_core/agents/__init__.py` | 1 | fix(prana): Enable headless plugin regis |
| `vibe_core/agents/context_aware_agent.py` | 1 | fix(prana): Enable headless plugin regis |
| `vibe_core/agents/llm_agent.py` | 1 | fix(prana): Enable headless plugin regis |
| `vibe_core/agents/specialist_agent.py` | 1 | fix(prana): Enable headless plugin regis |
| `vibe_core/agents/specialist_factory.py` | 1 | fix(prana): Enable headless plugin regis |
| `vibe_core/agents/system_maintenance.py` | 1 | fix(prana): Enable headless plugin regis |
| `vibe_core/boot_mode.py` | 1 | fix(prana): Enable headless plugin regis |
...
- `vibe_core/prana_orchestrator.py:496` - # TODO: Wire to actual karma system when ready
...
---
*Generated by OPUS Assistant Plugin | 2025-12-16 15:55:04 UTC*