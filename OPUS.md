...
**🟢 HEALTHY** | Updated: 2025-12-21 07:26:18 UTC | Kernel: RUNNING (0 agents)
...
| **Synapses File** | `2025-12-21T07:24:50` | 📄 .opus_state/synapses.json |
...
- **Branch:** `claude/analyze-steward-protocol-goWtw` @ `43714d6`
...
| **plugins** | Kernel Plugins Package | 220 | ✅ | `vibe_core/plugins/` |
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 7 | feat(opus096): Wire StateSyncWeaver into |
| `vibe_core/kernel_impl.py` | 6 | VAJRA ARMOR: Blueprint Immutability Prot |
| `vibe_core/plugins/opus_assistant/manas/cortex/viveka_action.py` | 3 | AMRITA PROTOCOL: Self-Healing Kernel (KU |
| `vibe_core/governance/harness_validator.py` | 3 |  |
| `vibe_core/plugins/opus_assistant/manas/cortex/__init__.py` | 2 | feat(opus166): PranaAction - MANAS gets  |
| `vibe_core/plugins/opus_assistant/manas/cortex/wiring_map.py` | 2 | feat(opus166): PranaAction - MANAS gets  |
| `vibe_core/runtime/syscalls.py` | 2 | fix: Format files and remove duplicate l |
| `vibe_core/security.py` | 2 | fix: Add missing security.py (VajraGuard |
| `vibe_core/plugins/node_pulse/plugin_main.py` | 2 | refactor(opus166): LASAGNE Architecture  |
| `vibe_core/plugins/opus_assistant/manas/intent_router.py` | 2 | Merge origin/main (VAJRA ARMOR) into OPU |
...
| Started | `2025-12-21T07:25:23.497024` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/analyze-steward-protocol-goWtw` |
...
*Last Scan: 2025-12-21 07:26:43 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-21 07:26:18 UTC*