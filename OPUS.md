...
Last Updated: 2025-12-15 15:08 UTC
...
**🟢 HEALTHY** | Updated: 2025-12-15 15:08:05 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/fix-cables-technical-debt-YkwAW` @ `fe0a91d`
...
**Trust Score: **🟢 HEALTHY** 88%** (35 docs verified, 21 without @HARNESS)
...
**55 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 152 | ✅ | `vibe_core/plugins/` |
...
|------|---------|-------------|
| `vibe_core/cli/unified_cli.py` | 2 | feat(080): Wire LLM provider to MANAS CL |
| `vibe_core/plugins/opus_assistant/plugin_main.py` | 2 | fix(079): Add missing _is_test_mode to O |
| `vibe_core/cartridges/system/archivist/tools/audit_tool.py` | 2 | fix(078): VAJRA wiring cleanup - reduce  |
| `vibe_core/cartridges/system/archivist/tools/observer_tool.py` | 2 | fix(078): VAJRA wiring cleanup - reduce  |
| `vibe_core/cartridges/system/archivist/tools/verifier_tool.py` | 2 | fix(078): VAJRA wiring cleanup - reduce  |
| `vibe_core/__init__.py` | 1 | Merge pull request #462 from kimeisele/o |
| `vibe_core/agent_interface.py` | 1 | Merge pull request #462 from kimeisele/o |
| `vibe_core/agent_protocol.py` | 1 | Merge pull request #462 from kimeisele/o |
| `vibe_core/agents/__init__.py` | 1 | Merge pull request #462 from kimeisele/o |
| `vibe_core/agents/context_aware_agent.py` | 1 | Merge pull request #462 from kimeisele/o |
...
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/fix-cables-technical-debt-YkwAW` |
...
---
*Generated by OPUS Assistant Plugin | 2025-12-15 15:08:05 UTC*