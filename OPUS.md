...
**🟡 DEGRADED** | Updated: 2025-12-24 16:19:17 UTC | Kernel: STOPPED (0 agents)
...
|------|---------|-------------|
| `vibe_core/kernel_impl.py` | 3 | [feat] OPUS-213: TaskManager uses atomic |
| `vibe_core/boot_orchestrator.py` | 3 | feat(core): Finalizing Shuddhi & Task So |
| `vibe_core/task_management/task_manager.py` | 2 | [feat] OPUS-213: TaskManager uses atomic |
| `vibe_core/cartridges/system/engineer/tools/shuddhi_tool.py` | 2 | feat(core): Finalizing Shuddhi & Task So |
| `vibe_core/protocols/shuddhi.py` | 2 | feat(core): Finalizing Shuddhi & Task So |
| `vibe_core/protocols/task.py` | 2 | feat(core): Finalizing Shuddhi & Task So |
| `vibe_core/shuddhi/engine.py` | 2 | feat(core): Finalizing Shuddhi & Task So |
| `vibe_core/shuddhi/kala_bridge.py` | 2 | feat(core): Finalizing Shuddhi & Task So |
| `vibe_core/shuddhi/log_monitor.py` | 2 | feat(core): Finalizing Shuddhi & Task So |
| `vibe_core/cartridges/system/civic/tools/dashboard_tool.py` | 2 | feat(core): Shuddhi Surgical Healing Eng |
...
| Started | `2025-12-24T16:19:08.753345` |
...
*Last Scan: 2025-12-24 16:19:43 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-24 16:19:17 UTC*