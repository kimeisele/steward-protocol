...
**🟢 HEALTHY** | Updated: 2025-12-16 15:55:36 UTC | Kernel: STOPPED (0 agents)
...
|------|---------|-------------|
| `vibe_core/__init__.py` | 1 | refactor(prana): Use dynamic PluginLoade |
| `vibe_core/agent_interface.py` | 1 | refactor(prana): Use dynamic PluginLoade |
| `vibe_core/agent_protocol.py` | 1 | refactor(prana): Use dynamic PluginLoade |
| `vibe_core/agents/__init__.py` | 1 | refactor(prana): Use dynamic PluginLoade |
| `vibe_core/agents/context_aware_agent.py` | 1 | refactor(prana): Use dynamic PluginLoade |
| `vibe_core/agents/llm_agent.py` | 1 | refactor(prana): Use dynamic PluginLoade |
| `vibe_core/agents/specialist_agent.py` | 1 | refactor(prana): Use dynamic PluginLoade |
| `vibe_core/agents/specialist_factory.py` | 1 | refactor(prana): Use dynamic PluginLoade |
| `vibe_core/agents/system_maintenance.py` | 1 | refactor(prana): Use dynamic PluginLoade |
| `vibe_core/boot_mode.py` | 1 | refactor(prana): Use dynamic PluginLoade |
...
| Started | `2025-12-16T15:55:30.371371` |
...
---
*Generated by OPUS Assistant Plugin | 2025-12-16 15:55:36 UTC*