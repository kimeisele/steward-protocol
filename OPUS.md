...
Last Updated: 2025-12-15 10:55 UTC
...
**🟢 HEALTHY** | Updated: 2025-12-15 10:55:57 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/complete-wiring-integration-iKMhK` @ `b3983aa`
...
**Trust Score: **🟢 HEALTHY** 87%** (32 docs verified, 21 without @HARNESS)
...
**52 documents** in `docs/architecture/OPUS/`
...
|------|---------|-------------|
| `vibe_core/capability_registry.py` | 2 | feat(opus-075): FORTRESS HARNESS - Deep  |
| `vibe_core/plugins/opus_assistant/core/verification_logic.py` | 2 | feat(opus-075): MANAS harness now semant |
| `vibe_core/__init__.py` | 1 | Merge pull request #457 from kimeisele/c |
| `vibe_core/agent_interface.py` | 1 | Merge pull request #457 from kimeisele/c |
| `vibe_core/agent_protocol.py` | 1 | Merge pull request #457 from kimeisele/c |
| `vibe_core/agents/__init__.py` | 1 | Merge pull request #457 from kimeisele/c |
| `vibe_core/agents/context_aware_agent.py` | 1 | Merge pull request #457 from kimeisele/c |
| `vibe_core/agents/llm_agent.py` | 1 | Merge pull request #457 from kimeisele/c |
| `vibe_core/agents/specialist_agent.py` | 1 | Merge pull request #457 from kimeisele/c |
| `vibe_core/agents/specialist_factory.py` | 1 | Merge pull request #457 from kimeisele/c |
...
| Started | `2025-12-15T10:48:18.383699` |
...
---
*Generated by OPUS Assistant Plugin | 2025-12-15 10:55:57 UTC*