...
**🟡 DEGRADED** | Updated: 2025-12-23 10:43:36 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `opus-211-integration` @ `4faf6ca`
...
|------|----------|--------|---------|
| `2.582385` | 🚨 | drift_detector | Persistent drift! 1524 consecutive unhealthy check |
| `2.577507` | ⚠️ | drift_detector | Drift detected: 35 missing files (tick #1524) |
| `1.983389` | 🚨 | drift_detector | Persistent drift! 1524 consecutive unhealthy check |
| `1.978299` | ⚠️ | drift_detector | Drift detected: 35 missing files (tick #1524) |
| `5.247894` | 🚨 | drift_detector | Persistent drift! 1523 consecutive unhealthy check |
| `5.243706` | ⚠️ | drift_detector | Drift detected: 35 missing files (tick #1523) |
| `4.649029` | 🚨 | drift_detector | Persistent drift! 1523 consecutive unhealthy check |
| `4.644901` | ⚠️ | drift_detector | Drift detected: 35 missing files (tick #1523) |
| `3.930108` | 🚨 | drift_detector | Persistent drift! 1522 consecutive unhealthy check |
| `3.927102` | ⚠️ | drift_detector | Drift detected: 35 missing files (tick #1522) |
| `3.161458` | 🚨 | drift_detector | Persistent drift! 1522 consecutive unhealthy check |
| `3.157448` | ⚠️ | drift_detector | Drift detected: 35 missing files (tick #1522) |
| `2.260907` | 🚨 | drift_detector | Persistent drift! 1521 consecutive unhealthy check |
| `1.865731` | ⚠️ | drift_detector | Drift detected: 35 missing files (tick #1521) |
| `1.108230` | 🚨 | drift_detector | Persistent drift! 1521 consecutive unhealthy check |
| ... | ... | ... | _+5 more entries_ |
...
**Trust Score: **🟡 DEGRADED** 78%** (99 docs verified, 38 without @HARNESS)
...
**136 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 263 | ✅ | `vibe_core/plugins/` |
| **protocols** | VIBE_CORE PROTOCOLS - Layer 1: Interfaces Only | 14 | ❌ | `vibe_core/protocols/` |
...
|------|---------|-------------|
| `vibe_core/loaders/code_module_loader.py` | 2 | fix(manas): enforce config weights in Pr |
| `vibe_core/plugins/opus_assistant/manas/cortex/prakriti_sense.py` | 2 | fix(manas): enforce config weights in Pr |
| `vibe_core/__init__.py` | 1 | 🍎 Auto-commit (threshold): 2 state files |
| `vibe_core/agent_interface.py` | 1 | 🍎 Auto-commit (threshold): 2 state files |
| `vibe_core/agent_protocol.py` | 1 | 🍎 Auto-commit (threshold): 2 state files |
| `vibe_core/agents/__init__.py` | 1 | 🍎 Auto-commit (threshold): 2 state files |
| `vibe_core/agents/context_aware_agent.py` | 1 | 🍎 Auto-commit (threshold): 2 state files |
| `vibe_core/agents/llm_agent.py` | 1 | 🍎 Auto-commit (threshold): 2 state files |
| `vibe_core/agents/specialist_agent.py` | 1 | 🍎 Auto-commit (threshold): 2 state files |
| `vibe_core/agents/specialist_factory.py` | 1 | 🍎 Auto-commit (threshold): 2 state files |
...
| Started | `2025-12-23T10:43:29.024999` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `opus-211-integration` |
...
| --- | --- | --- |
| Hidden Code Elements | 467 | ⚠️ 25 high priority |
...
*Last Scan: 2025-12-23 10:43:52 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-23 10:43:36 UTC*