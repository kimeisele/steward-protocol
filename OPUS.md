...
**🟡 DEGRADED** | Updated: 2025-12-24 17:59:07 UTC | Kernel: STOPPED (0 agents)
...
**Trust Score: **🟡 DEGRADED** 75%** (100 docs verified, 41 without @HARNESS)
...
**140 documents** in `docs/architecture/OPUS/`
...
| **protocols** | VIBE_CORE PROTOCOLS - Layer 1: Interfaces Only | 18 | ❌ | `vibe_core/protocols/` |
...
|------|---------|-------------|
| `vibe_core/kernel_impl.py` | 3 | refactor(kernel): decouple state from ke |
| `vibe_core/protocols/ledger.py` | 2 | refactor(kernel): decouple state from ke |
| `vibe_core/state/git_state.py` | 2 | refactor(kernel): decouple state from ke |
| `vibe_core/state/kernel_state.py` | 2 | refactor(kernel): decouple state from ke |
| `vibe_core/state/prakriti.py` | 2 | refactor(kernel): decouple state from ke |
| `vibe_core/runtime/unified_execution.py` | 2 | refactor(kernel): break circular depende |
| `vibe_core/state/schema.py` | 2 | refactor(kernel): break circular depende |
| `vibe_core/plugins/task_manager/state_store.py` | 2 | chore(cleanup): OPUS-213 Phase 4 state f |
| `vibe_core/agent_interface.py` | 2 | fix(core): Unify TaskStatus, fix civic t |
| `vibe_core/cartridges/system/civic/tools/economy.py` | 2 | fix(core): Unify TaskStatus, fix civic t |
...
| Started | `2025-12-24T17:59:01.195683` |
...
| Roadmap Items | 103 | 📋 Action needed |
| Intent Clusters | 0 | ⚪ |
...
*Last Scan: 2025-12-24 17:59:24 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-24 17:59:07 UTC*