...
Last Updated: 2025-12-18 20:47 UTC
...
**🟡 DEGRADED** | Updated: 2025-12-18 20:46:55 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/enhance-prompt-manas-LhkjA` @ `25abe47`
...
**Trust Score: **🟡 DEGRADED** 77%** (61 docs verified, 17 without @HARNESS)
...
**77 documents** in `docs/architecture/OPUS/`
...
| `vibe_core/plugins/opus_assistant/manas/intent_router.py` | 5 | feat(opus-106): Wire ToolLoader into Int |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 5 | feat(opus-106): Add ToolLoader to Cognit |
| `vibe_core/loaders/__init__.py` | 5 | feat(veda-4): Standardize loaders with C |
| `vibe_core/plugins/interface/renderers/cognition.py` | 4 | feat(opus-108): Enhance COGNITION.md wit |
| `vibe_core/plugins/opus_assistant/events/kernel_tick.py` | 4 | feat(opus-108): The Autonomy Loop - MANA |
| `vibe_core/loaders/action_loader.py` | 4 | feat(veda-4): Add fractal loader pattern |
| `vibe_core/plugins/opus_assistant/manas/cortex/wiring_map.py` | 4 | fix(manas): OPUS-105 Fortress Fortificat |
| `vibe_core/plugins/opus_assistant/manas/intent_generator.py` | 4 | feat(manas): OPUS-101 Hybrid Router - Ac |
| `vibe_core/plugins/opus_assistant/render/opus_dashboard_renderer.py` | 3 | feat(opus-106): Wire SANKALPA strategic  |
...
| Started | `2025-12-18T20:46:34.667135` |
...
*Last Scan: 2025-12-18 20:47:06 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-18 20:46:55 UTC*