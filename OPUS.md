...
**🟡 DEGRADED** | Updated: 2025-12-19 16:20:28 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/synaptic-learning-update-HQDRc` @ `512194c`
...
**Trust Score: **🟡 DEGRADED** 78%** (68 docs verified, 25 without @HARNESS)
...
| 116-SILENT-OBSERVER.md | - | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| 117-FRACTAL-INTEGRATION.m | - | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
...
- **009-UNIFIED-STATE-PRAKRITI.md** [wiring]: prakriti\.commit_if_dirty in vibe_core/kernel_impl.py
- **009-UNIFIED-STATE-PRAKRITI.md** [wiring]: self\.sync_holon in vibe_core/kernel_impl.py
- **009-UNIFIED-STATE-PRAKRITI.md** [wiring]: \.opus_state in vibe_core/plugins/opus_assistant/plugin_main.py
- **009-UNIFIED-STATE-PRAKRITI.md** [wiring]: \.vibe/state in vibe_core/task_management/task_manager.py
- **009-UNIFIED-STATE-PRAKRITI.md** [wiring]: def get_state_paths in vibe_core/plugins/opus_assistant/plugin_main.py
- **009-UNIFIED-STATE-PRAKRITI.md** [wiring]: def get_state_paths in vibe_core/task_management/task_manager.py
- **009-UNIFIED-STATE-PRAKRITI.md** [config]: prakriti.guna_thresholds
- _...and 136 more_
...
**92 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 180 | ✅ | `vibe_core/plugins/` |
...
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 3 | feat(OPUS-112): Synaptic Inference - The |
| `vibe_core/lineage.py` | 2 | feat(OPUS-126): The Karma Loop (Samskara |
| `vibe_core/plugins/task_manager/state_store.py` | 2 | feat(OPUS-122): Task Alignment - Full Cl |
| `vibe_core/scheduling/task.py` | 2 | feat(OPUS-122): Task Alignment - Full Cl |
| `vibe_core/task_management/models.py` | 2 | feat(OPUS-122): Task Alignment - Full Cl |
...
| Started | `2025-12-19T16:20:00.514817` |
...
| --- | --- | --- |
| Git HEAD | `512194c` | ⚪ |
| Ledger HEAD | `2b09813a0e58` | ⚪ |

### 🔮 Tri-Guna (State Health)

| Guna | Count | Meaning |
| --- | --- | --- |
| ✅ Sattva | 5 | Synced & Clean |
| 🟡 Rajas | 0 | Active & Dirty |
...
| --- | --- | --- |
| Hidden Code Elements | 317 | ⚠️ 9 high priority |
| Roadmap Items | 66 | 📋 Action needed |
| Intent Clusters | 0 | ⚪ |
...
*Last Scan: 2025-12-19 16:20:43 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-19 16:20:28 UTC*