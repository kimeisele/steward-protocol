...
**🟢 HEALTHY** | Updated: 2025-12-20 13:49:37 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/state-file-architecture-PigwR` @ `f6f6d52`
...
**Trust Score: **🟢 HEALTHY** 81%** (78 docs verified, 23 without @HARNESS)
...
**100 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 196 | ✅ | `vibe_core/plugins/` |
...
|------|---------|-------------|
| `vibe_core/state/__init__.py` | 4 | feat(state): OPUS-140 Sanskrit Matrix -  |
| `vibe_core/state/state_service.py` | 3 | chore(state): Auto-sync runtime state |
| `vibe_core/plugins/opus_assistant/manas/dojo/__init__.py` | 2 | feat(dojo): OPUS-140 MeditationRoom - Ja |
| `vibe_core/plugins/opus_assistant/manas/dojo/rooms/__init__.py` | 2 | feat(dojo): OPUS-140 MeditationRoom - Ja |
| `vibe_core/state/weaver.py` | 2 | chore(state): Auto-sync runtime state |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 2 | feat(state): P0 StateService - Single Po |
| `vibe_core/plugins/opus_assistant/manas/cortex/viveka_action.py` | 2 | feat(state): P0 StateService - Single Po |
| `vibe_core/plugins/opus_assistant/manas/intent_router.py` | 2 | feat(state): P0 StateService - Single Po |
| `vibe_core/plugins/opus_assistant/manas/dojo/rooms/meditation.py` | 1 | feat(dojo): OPUS-140 MeditationRoom - Ja |
| `vibe_core/state/sanskrit_matrix.py` | 1 | feat(state): OPUS-140 Sanskrit Matrix -  |
...
| Started | `2025-12-20T13:49:09.697581` |
...
| --- | --- | --- |
| Hidden Code Elements | 365 | ⚠️ 10 high priority |
...
*Last Scan: 2025-12-20 13:49:52 UTC*
...
- `vibe_core/state/weaver.py:456` - # TODO: Actual MANAS learning
...
---
*Generated by OPUS Assistant Plugin | 2025-12-20 13:49:37 UTC*