...
**🟢 HEALTHY** | Updated: 2025-12-13 20:30:13 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/fix-merge-conflict-01N38bUtnX3WuFCJFtPxijj4` @ `360311a`
...
- **Trend:** ➡️ Stable- **Last Update:** `2025-12-13T19:52:06.912984` (errors: 3, crashes: 0)
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/events/kernel_tick.py` | 22 | feat(opus): GREMIUM - AI Federation for  |
| `vibe_core/plugins/opus_assistant/render/opus_dashboard_renderer.py` | 16 | feat(opus): Add Volition - Intent Approv |
| `vibe_core/plugins/opus_assistant/plugin_main.py` | 9 | feat(opus): Wire Layer 2 syscall event s |
| `vibe_core/plugins/opus_assistant/core/state_manager.py` | 8 | feat(opus): Complete Layer 1.5 Intent Bu |
| `vibe_core/plugins/opus_assistant/core/observation_logger.py` | 5 | Merge pull request #425 from kimeisele/c |
| `vibe_core/cartridges/agent_city/dharma/cartridge_main.py` | 4 | refactor(dharma): Single source of truth |
| `vibe_core/plugins/interface/renderers/opus/renderer.py` | 4 | Merge pull request #425 from kimeisele/c |
| `vibe_core/plugins/opus_assistant/cli/commands.py` | 4 | Merge pull request #425 from kimeisele/c |
| `vibe_core/plugins/opus_assistant/core/control_cables.py` | 4 | feat(opus): Add Volition - Intent Approv |
| `vibe_core/plugins/opus_assistant/manas/intent_generator.py` | 4 | feat(opus): Add The Ouroboros Protocol - |
...
---
*Generated by OPUS Assistant Plugin | 2025-12-13 20:30:13 UTC*