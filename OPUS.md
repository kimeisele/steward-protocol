...
**🟡 DEGRADED** | Updated: 2025-12-18 11:42:51 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/enhance-prompt-manas-LhkjA` @ `9a71b13`
...
**Trust Score: **🟡 DEGRADED** 77%** (53 docs verified, 17 without @HARNESS)
...
**69 documents** in `docs/architecture/OPUS/`
...
| **loaders** | Unified Loader System - VEDA-4 Pattern for ALL Item Types. | 9 | ❌ | `vibe_core/loaders/` |
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/intent_generator.py` | 3 | feat(manas): OPUS-098 AnalyzerLoader - V |
| `vibe_core/loaders/__init__.py` | 2 | feat(manas): OPUS-098 AnalyzerLoader - V |
...
| `vibe_core/loaders/analyzer_loader.py` | 1 | feat(manas): OPUS-098 AnalyzerLoader - V |
...
| Started | `2025-12-18T11:42:45.942682` |
...
| Roadmap Items | 43 | 📋 Action needed |
| Intent Clusters | 0 | ⚪ |
...
*Last Scan: 2025-12-18 11:42:59 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-18 11:42:51 UTC*