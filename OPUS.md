...
**🟡 DEGRADED** | Updated: 2025-12-17 21:48:00 UTC | Kernel: STOPPED (0 agents)
...
|------|---------|-------------|
| `vibe_core/prana_orchestrator.py` | 4 | fix(OPUS-095): Add backward compatibilit |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 4 | feat(OPUS-095): Phase B - CognitiveKerne |
| `vibe_core/boot_orchestrator.py` | 3 | feat(OPUS-095): Phase D & E - BootOrches |
| `vibe_core/plugins/opus_assistant/manas/circuit_executor.py` | 3 | feat(OPUS-095): Phase D & E - BootOrches |
| `vibe_core/plugins/opus_assistant/manas/cortex/dharma_sense.py` | 3 | Merge pull request #518 from kimeisele/c |
| `vibe_core/plugins/opus_assistant/manas/cortex/prakriti_sense.py` | 3 | Merge pull request #518 from kimeisele/c |
| `vibe_core/plugins/opus_assistant/render/opus_dashboard_renderer.py` | 3 | Merge pull request #518 from kimeisele/c |
| `vibe_core/orchestration_cycle.py` | 2 | feat(OPUS-095): Global CycleRegistry sin |
| `vibe_core/__init__.py` | 2 | Merge pull request #518 from kimeisele/c |
| `vibe_core/agent_interface.py` | 2 | Merge pull request #518 from kimeisele/c |
...
| Started | `2025-12-17T21:47:49.794112` |
...
*Last Scan: 2025-12-17 21:48:11 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-17 21:48:00 UTC*