...
**🟡 DEGRADED** | Updated: 2025-12-22 13:17:16 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `adr-204-async-persistence` @ `526714b`
...
|------|----------|--------|---------|
| `9.935475` | 🚨 | drift_detector | Persistent drift! 30 consecutive unhealthy checks |
| `9.933416` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #30) |
| `9.161221` | 🚨 | drift_detector | Persistent drift! 29 consecutive unhealthy checks |
| `9.158504` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #29) |
| `8.454203` | 🚨 | drift_detector | Persistent drift! 28 consecutive unhealthy checks |
| `8.452226` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #28) |
| `7.811385` | 🚨 | drift_detector | Persistent drift! 27 consecutive unhealthy checks |
| `7.809394` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #27) |
| `7.083164` | 🚨 | drift_detector | Persistent drift! 26 consecutive unhealthy checks |
| `7.082008` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #26) |
| `6.331823` | 🚨 | drift_detector | Persistent drift! 25 consecutive unhealthy checks |
| `6.328563` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #25) |
| `5.469538` | 🚨 | drift_detector | Persistent drift! 24 consecutive unhealthy checks |
| `5.467543` | ⚠️ | drift_detector | Drift detected: 34 missing files (tick #24) |
| `4.668541` | 🚨 | drift_detector | Persistent drift! 23 consecutive unhealthy checks |
| ... | ... | ... | _+5 more entries_ |
...
**Trust Score: **🟡 DEGRADED** 79%** (97 docs verified, 34 without @HARNESS)
...
**130 documents** in `docs/architecture/OPUS/`
...
|------|---------|-------------|
| `vibe_core/kernel_impl.py` | 7 | feat(state): implement ADR-204 Async Per |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 5 | fix(manas): Remove 61 unused imports, fi |
| `vibe_core/state/state_service.py` | 3 | feat(arch): finalize ADR-204 Sovereign A |
| `vibe_core/plugins/opus_assistant/manas/action_manager.py` | 3 | fix(manas): Remove 61 unused imports, fi |
| `vibe_core/ledger.py` | 2 | feat(arch): finalize ADR-204 Sovereign A |
| `vibe_core/state/weaver.py` | 2 | feat(state): implement Sovereign Intelli |
| `vibe_core/reactor/__init__.py` | 2 | feat(reactor): OPUS-200/201 REAL Sanskri |
| `vibe_core/reactor/agni.py` | 2 |  |
| `vibe_core/reactor/atom.py` | 2 |  |
| `vibe_core/task_kernel.py` | 2 | feat(security): OPUS-176 BHARAT - Asymme |
...
| Started | `2025-12-22T13:17:11.843108` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `adr-204-async-persistence` |
...
| --- | --- | --- |
| Hidden Code Elements | 461 | ⚠️ 25 high priority |
| Roadmap Items | 93 | 📋 Action needed |
| Intent Clusters | 0 | ⚪ |
...
*Last Scan: 2025-12-22 13:17:31 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-22 13:17:16 UTC*