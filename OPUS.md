...
**🟡 DEGRADED** | Updated: 2025-12-18 15:19:41 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/enhance-prompt-manas-LhkjA` @ `5df4203`
...
| **loaders** | Unified Loader System - VEDA-4 Pattern for ALL Item Types. | 11 | ❌ | `vibe_core/loaders/` |
...
| `vibe_core/loaders/__init__.py` | 4 | feat(manas): OPUS-100 ActionLoader - VED |
...
| `vibe_core/plugins/opus_assistant/manas/api.py` | 2 | feat(opus-106): Wire ManasOracle bidirec |
| `vibe_core/plugins/opus_assistant/manas/cortex/jnana.py` | 2 | feat(opus-106): Wire CognitiveWeaver int |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 2 | feat(manas): Wire CognitiveWeaver into M |
...
| Started | `2025-12-18T15:19:31.575915` |
...
*Last Scan: 2025-12-18 15:19:52 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-18 15:19:41 UTC*