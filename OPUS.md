...
**🟡 DEGRADED** | Updated: 2025-12-24 14:13:16 UTC | Kernel: STOPPED (0 agents)
...
**Trust Score: **🟡 DEGRADED** 75%** (99 docs verified, 39 without @HARNESS)
...
**137 documents** in `docs/architecture/OPUS/`
...
| **protocols** | VIBE_CORE PROTOCOLS - Layer 1: Interfaces Only | 17 | ❌ | `vibe_core/protocols/` |
...
|------|---------|-------------|
| `vibe_core/cartridges/system/engineer/cartridge_main.py` | 2 | chore: architectural shuddhi and libcst  |
| `vibe_core/cartridges/system/watchman/tools/standards_inspection.py` | 2 | chore: architectural shuddhi and libcst  |
| `vibe_core/cli/unified_cli.py` | 2 | chore: architectural shuddhi and libcst  |
| `vibe_core/genesis/compliance.py` | 2 | chore: architectural shuddhi and libcst  |
| `vibe_core/plugins/interface/renderers/economy.py` | 2 | chore: architectural shuddhi and libcst  |
| `vibe_core/plugins/interface/renderers/opus/renderer.py` | 2 | chore: architectural shuddhi and libcst  |
| `vibe_core/__init__.py` | 1 | fix(kernel): eliminate silent failures i |
| `vibe_core/agent_interface.py` | 1 | fix(kernel): eliminate silent failures i |
| `vibe_core/agent_protocol.py` | 1 | fix(kernel): eliminate silent failures i |
| `vibe_core/agents/__init__.py` | 1 | fix(kernel): eliminate silent failures i |
...
| Started | `2025-12-24T14:13:04.500276` |
...
*Last Scan: 2025-12-24 14:13:36 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-24 14:13:16 UTC*