...
**🟢 HEALTHY** | Updated: 2025-12-17 11:17:19 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/manas-billion-dollar-app-yhkDE` @ `40fed34`
...
**Trust Score: **🟢 HEALTHY** 80%** (49 docs verified, 16 without @HARNESS)
...
**64 documents** in `docs/architecture/OPUS/`
...
| **plugins** | Kernel Plugins Package | 172 | ✅ | `vibe_core/plugins/` |
...
|------|---------|-------------|
| `vibe_core/runtime/providers/factory.py` | 3 | fix(factory): OpenAI as standard fallbac |
| `vibe_core/plugins/opus_assistant/manas/analyzers/contract_analyzer.py` | 2 | feat(manas): Complete semantic weaving a |
| `vibe_core/plugins/opus_assistant/manas/analyzers/doc_harness_analyzer.py` | 2 | feat(manas): Add weaving to DocHarnessAn |
| `vibe_core/plugins/opus_assistant/manas/intent_generator.py` | 2 | feat(manas): Add Intent weaving fields - |
| `vibe_core/plugins/opus_assistant/manas/cortex/jnana.py` | 2 | feat(manas): Wire JnanaHandler to OpenRo |
| `vibe_core/__init__.py` | 1 | Merge pull request #509 from kimeisele/c |
| `vibe_core/agent_interface.py` | 1 | Merge pull request #509 from kimeisele/c |
| `vibe_core/agent_protocol.py` | 1 | Merge pull request #509 from kimeisele/c |
| `vibe_core/agents/__init__.py` | 1 | Merge pull request #509 from kimeisele/c |
| `vibe_core/agents/context_aware_agent.py` | 1 | Merge pull request #509 from kimeisele/c |
...
| Started | `2025-12-17T11:15:49.345194` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/manas-billion-dollar-app-yhkDE` |
...
| Bhakti | ⚪ **5/200** | Earned trust (devotion) |
...
| Total OPUS Docs | 30 | - |
| With @HARNESS | 19 | ✅ |
| Without @HARNESS | 11 | ⚠️ |
| Doc/Code Gaps | 44 | 🔴 |
| Health Ratio | **63%** | 🟡 |

**Top Gaps (Need Attention):**
- 🔴 `missing_code`: Doc 054-SUTRA.md references your/module/file.py          # < (054-SUTRA.md)
- 🔴 `missing_code`: Doc 054-SUTRA.md references tests/test_your_module.py    # < (054-SUTRA.md)
...
| --- | --- | --- |
| Hidden Code Elements | 286 | ⚠️ 14 high priority |
| Roadmap Items | 40 | 📋 Action needed |
| Intent Clusters | 0 | ⚪ |

**Roadmap Preview (Top 5):**
- [P1] `fix_code_reference` → 054-SUTRA.md (small)
- [P1] `fix_code_reference` → 054-SUTRA.md (small)
- [P1] `fix_code_reference` → 077-PRATYAYA-MUTATION.md (small)
- [P2] `add_harness` → 056-SHUDDHI.md (trivial)
- [P2] `add_harness` → 057-VAJRA.md (trivial)


*Last Scan: 2025-12-17 11:17:24 UTC*
...
**Total: 18** (TODO: 18, HACK: 0, FIXME: 0)

<details>
<summary>TODOs (18)</summary>
...
---
*Generated by OPUS Assistant Plugin | 2025-12-17 11:17:19 UTC*