...
**🟢 HEALTHY** | Updated: 2025-12-15 09:58:05 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/complete-wiring-integration-iKMhK` @ `fe049a6`
...
- **Trend:** ➡️ Stable- **Last Update:** `2025-12-15T09:57:58.061710` (errors: 0, crashes: 0)
...
**Trust Score: **🟢 HEALTHY** 87%** (31 docs verified, 21 without @HARNESS)
...
**51 documents** in `docs/architecture/OPUS/`
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/intent_router.py` | 8 | feat(opus-071): 📜 SUTRA Wiki Sync Live - |
| `vibe_core/plugins/opus_assistant/events/kernel_tick.py` | 4 | feat(opus-071): 🌉 Governance Bridge - P1 |
| `vibe_core/plugins/vedic_governance/plugin_main.py` | 3 | Revert "feat(opus-071): 💰 Wallet Stub -  |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 2 | feat(opus-074): Implement VAJRA + Memory |
| `vibe_core/event_bus.py` | 2 | fix(opus-073): Correct documentation aft |
| `vibe_core/kernel_impl.py` | 2 | revert: Undo OPUS-073 KERNEL_TICK wiring |
...
| `vibe_core/plugins/opus_assistant/manas/validator.py` | 2 | fix(opus-069): Wire SrutiValidator to ke |
| `vibe_core/plugins/opus_assistant/manas/cortex/prakriti.py` | 2 |  |
...
| Started | `2025-12-15T09:57:58.055415` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/complete-wiring-integration-iKMhK` |
...
---
*Generated by OPUS Assistant Plugin | 2025-12-15 09:58:05 UTC*