...
Last Updated: 2025-12-18 08:42 UTC
...
**🟡 DEGRADED** | Updated: 2025-12-18 08:41:55 UTC | Kernel: RUNNING (0 agents)
...
- **Branch:** `claude/build-manas-opus-nkwBE` @ `f792cf0`
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 2 | fix(manas): Wire critical missing cables |
| `vibe_core/__init__.py` | 1 | fix(OPUS-095): Complete PR #522 fixes -  |
| `vibe_core/agent_interface.py` | 1 | fix(OPUS-095): Complete PR #522 fixes -  |
| `vibe_core/agent_protocol.py` | 1 | fix(OPUS-095): Complete PR #522 fixes -  |
| `vibe_core/agents/__init__.py` | 1 | fix(OPUS-095): Complete PR #522 fixes -  |
| `vibe_core/agents/context_aware_agent.py` | 1 | fix(OPUS-095): Complete PR #522 fixes -  |
| `vibe_core/agents/llm_agent.py` | 1 | fix(OPUS-095): Complete PR #522 fixes -  |
| `vibe_core/agents/specialist_agent.py` | 1 | fix(OPUS-095): Complete PR #522 fixes -  |
| `vibe_core/agents/specialist_factory.py` | 1 | fix(OPUS-095): Complete PR #522 fixes -  |
| `vibe_core/agents/system_maintenance.py` | 1 | fix(OPUS-095): Complete PR #522 fixes -  |
...
| Started | `2025-12-18T08:41:42.539017` |
...
*Last Scan: 2025-12-18 08:42:01 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-18 08:41:55 UTC*