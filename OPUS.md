...
**🟢 HEALTHY** | Updated: 2025-12-17 00:04:13 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/unified-state-management-wDhNc` @ `56b409f`
...
**Trust Score: **🟢 HEALTHY** 83%** (41 docs verified, 24 without @HARNESS)
...
|------|---------|-------------|
| `vibe_core/plugins/interface/renderers/opus/panels/prakriti_state.py` | 3 | fix(opus-009): LOBOTOMY HEALED - State d |
| `vibe_core/plugins/task_manager/plugin_main.py` | 2 | feat(opus-009): TRIPLE STRIKE - Wire Pra |
| `vibe_core/plugins/test_orchestration/plugin_main.py` | 2 | feat(opus-009): TRIPLE STRIKE - Wire Pra |
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 2 | feat(opus-009): Wire PrakritiSense into  |
| `vibe_core/plugins/opus_assistant/manas/cortex/__init__.py` | 2 | feat(opus-009): PRAKRITI SENSE - Das sec |
| `vibe_core/state/__init__.py` | 2 | feat(opus-009): StateSyncHolon - The Zwi |
| `vibe_core/plugins/opus_assistant/manas/cortex/prakriti_sense.py` | 1 | feat(opus-009): PRAKRITI SENSE - Das sec |
| `vibe_core/state/sync_holon.py` | 1 | feat(opus-009): StateSyncHolon - The Zwi |
| `vibe_core/__init__.py` | 1 | Merge pull request #493 from kimeisele/f |
| `vibe_core/agent_interface.py` | 1 | Merge pull request #493 from kimeisele/f |
...
| Started | `2025-12-17T00:04:11.222910` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/unified-state-management-wDhNc` |
...
---
*Generated by OPUS Assistant Plugin | 2025-12-17 00:04:13 UTC*