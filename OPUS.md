...
**🟢 HEALTHY** | Updated: 2025-12-17 14:45:46 UTC | Kernel: STOPPED (0 agents)
...
- **Branch:** `claude/review-manas-activity-URPIL` @ `5617623`
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 12 | fix(manas): ObservationLogger init uses  |
| `vibe_core/plugins/opus_assistant/manas/intent_router.py` | 8 | feat(manas): Wire Shiva's Dreaming + San |
...
| `vibe_core/plugins/opus_assistant/manas/cortex/jnana.py` | 2 | fix(llm): Native messages support in Ope |
| `vibe_core/runtime/providers/factory.py` | 2 | fix(factory): OpenAI as standard fallbac |
...
| Started | `2025-12-17T14:45:39.008104` |

### 🔮 Three Layers

| Layer | Name | Status | Details |
| --- | --- | --- | --- |
| 1 | STHULA (Physical) | 🟡 | Dirty on `claude/review-manas-activity-URPIL` |
...
*Last Scan: 2025-12-17 14:45:50 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-17 14:45:46 UTC*