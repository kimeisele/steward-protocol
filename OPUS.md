...
Last Updated: 2025-12-20 10:56 UTC
...
**🟢 HEALTHY** | Updated: 2025-12-20 10:56:41 UTC | Kernel: STOPPED (0 agents)
...
|-------|-----------|--------|
| **Last Synapse Update** | `2025-12-20T10:40:50` | 🟢 Active |
| **Last Viveka Decision** | `2025-12-20T10:40:50` | 🔱 Active |
| **Last Reinforcement** | `2025-12-20T10:40:50` | ✅ +0.05 |
| **Synapses File** | `2025-12-20T10:40:50` | 📄 .opus_state/synapses.json |

<details>
<summary>Last Reinforcement Details</summary>

- **Intent:** `evaluate_tool_output`
- **Title:** [GAD-VIOLATION] Tool prints instead of returning
- **Result:** ✅ Success- **Weight:** 0.250 → 0.300
- **Delta:** 0.050
...
|--------|-------|-------------|
| **Synapses** | 21 triggers / 21 connections | Learned patterns |
| **Avg Weight** | 🟠 **0.45** | Pattern confidence |
| **High Confidence** | 0 | Weights > 0.8 |
| **Low Confidence** | 0 | Weights < 0.3 |
| **Latest Learning** | `2025-12-20T10:40:50` | Most recent synapse |
...
|--------|----------|---------------|-----------|
| `delete_files` | 🚫 BLOCK | 0.15 | `2025-12-20T10:40` |
| `modify_kernel` | 🚫 BLOCK | 0.05 | `2025-12-20T10:40` |
| `shell_execute` | 🚫 BLOCK | 0.10 | `2025-12-20T10:40` |
| `read_secrets` | 🚫 BLOCK | 0.05 | `2025-12-20T10:40` |
| `prompt_injection_test` | 🚫 BLOCK | 0.10 | `2025-12-20T10:40` |
...
- **Branch:** `claude/opus-manas-training-lHO0B` @ `30825d7`
...
|------|---------|-------------|
| `vibe_core/plugins/opus_assistant/manas/cortex/viveka_action.py` | 8 | feat(OPUS-133): GURUKULA Integration - A |
| `vibe_core/plugins/opus_assistant/manas/dojo/__init__.py` | 4 | feat(OPUS-133): GURUKULA Phase 1 - GAD-0 |
...
| `vibe_core/plugins/opus_assistant/manas/cognitive_kernel.py` | 2 | feat(OPUS-133): GURUKULA Integration - A |
| `vibe_core/plugins/opus_assistant/manas/cortex/viveka_sense.py` | 2 | feat(OPUS-133): GURUKULA Integration - A |
| `vibe_core/plugins/opus_assistant/manas/dojo/agency.py` | 2 | feat(OPUS-133): GURUKULA Phase 1 - GAD-0 |
...
| Started | `2025-12-20T10:56:31.142261` |
...
| --- | --- | --- |
| Hidden Code Elements | 343 | ⚠️ 10 high priority |
...
*Last Scan: 2025-12-20 10:56:56 UTC*
...
---
*Generated by OPUS Assistant Plugin | 2025-12-20 10:56:41 UTC*