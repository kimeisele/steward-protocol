...
- **SCRIBE** (ScribeCartridge) — Documentation agent: auto-generates AGENTS.md, CITYMAP.md, HELP.md, README.md, INFRASTRUCTURE.md
...
| **SCRIBE** | INFRASTRUCTURE | `ScribeCartridge` | Documentation agent: auto-generates AGENTS.md, CITYMAP.md, HELP.md, README.md, INFRASTRUCTURE.md |
