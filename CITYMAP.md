...
**Last Updated:** 2025-11-24 10:53 UTC
...
| **CIVIC** | INFRASTRUCTURE | `CivicCartridge` |  |
| **ENGINEER** | INFRASTRUCTURE | `EngineerCartridge` | THE ENGINEER - Meta-Agent & Builder. |
| **FORUM** | GOVERNANCE | `ForumCartridge` |  |
| **HERALD** | MEDIA | `HeraldCartridge` |  |
| **SCIENCE** | SCIENCE | `ScientistCartridge` |  |
